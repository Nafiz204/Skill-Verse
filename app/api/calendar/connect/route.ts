...
export async function POST(request: NextRequest) {
  try {
    ...
    // Get or create Skill Verse calendar
    const calendarId = await calendarService.getOrCreateSkillVerseCalendar()
    ...
    if (existingSettings) {
      ...
      await supabase
        ...
        .update({
          ...
          calendar_name: calendarDetails.summary || 'Skill Verse Learning Tasks',
          is_connected: true,
          sync_enabled: true,
