        ...
        <div className="absolute inset-0 z-[100] flex flex-col items-center justify-center px-4" style={{ pointerEvents: 'none' }}>
          <div className="text-center flex flex-col items-center">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-8">
              Skill Verse combines world-class courses with AI-powered task planning
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-white/70 leading-relaxed">
                Transform your expertise into engaging courses. Skill Verse provides everything you need to create, manage, and monetize your knowledge.
              </p>
        ...
        <div className="mx-auto w-full max-w-6xl grid grid-cols-1 items-center gap-8 md:grid-cols-2 relative z-10">
          <ContainerStagger>
            ...
            <ContainerAnimated className="my-4 text-base text-white/70 md:my-6 md:text-lg leading-relaxed">
              Join thousands of educators and learners already using Skill Verse to achieve their goals.
